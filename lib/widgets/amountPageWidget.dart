...
class AmountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemCount: (_amount["transactions"] as List).length,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(_amount['balance'],
                    style: textTheme.display1.apply(color: Colors.white)),
          ...
          child: Row(
            children: <Widget>[
              ...
              Text(transactions['amount'],
                  style: textTheme.body2.apply(color: Colors.black))
            ],
          ),
        );
      },
